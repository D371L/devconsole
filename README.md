...
- 💾 **Гибкое хранение данных** (PostgreSQL + Backend API)
...
- Методы для всех CRUD операций:
  ...
  - Tasks: `getTasks()`, `createTask()`, `updateTask()`, `deleteTask()`, `addComment()`
...
- URL: http://68.183.146.188
- Backend API: http://68.183.146.188/api/health
- Статус: ✅ Работает
...
**Архитектура:** Frontend (React) + Backend API (Node.js/Express) + PostgreSQL + AI (Gemini)
